...
insert into products (product_id, product_class_id , brand_name,product_name, price) values (11,30,'Nike','Shoes',200.5);
insert into products (product_id, product_class_id , brand_name,product_name, price) values (12,40,'Nike','Sweats',80.5);
insert into products (product_id, product_class_id , brand_name,product_name, price) values (13,30,'Adiddas','Shoes',00.5);
insert into products (product_id, product_class_id , brand_name,product_name, price) values (14,40,'Adiddas','Sweats',100.5);
insert into products (product_id, product_class_id , brand_name,product_name, price) values (15,50,'UA','Pretty_s',400.5);
insert into products (product_id, product_class_id , brand_name,product_name, price) values (16,60,'UA','Hoodie',60.5);
insert into products (product_id, product_class_id , brand_name,product_name, price) values (17,70,'New_B','Shoes_lady',120);
insert into products (product_id, product_class_id , brand_name,product_name, price) values (18,30,'New_B','Shoes',31.5);
